...
import AddPlacedStudentModal from '@/features/students/AddPlacedStudentModal';

function StudentDetails() {
  const [isByBatchActive, setIsByBatchActive] = useState(true);
  const [isAddPlacedModalOpen, setIsAddPlacedModalOpen] = useState(false);
  ...
  function handleOnAddPlacedStudent() {
    ...
    setIsAddPlacedModalOpen((curr) => !curr);
  }
  return (
    <>
       ...
       batch or all placed students tab is active */}
        ...
        {!isByBatchActive && (
          <div className="text-end">
            <Button onClick={handleOnAddPlacedStudent}>
              Add Placed Student
            </Button>
          </div>
        )}
      </div>
      {isAddPlacedModalOpen && (
        <AddPlacedStudentModal onClose={handleOnAddPlacedStudent} />
      )}
    </>
  );
}
